...
namespace Smb.Core
{
    internal enum RequestedOplockLevels : Byte
    {
        /// <summary>
    ...
    internal enum ImpersonationLevelsRequest : UInt32
    {
        /// <summary>
    ...
    internal enum ShareAccessRequest : UInt32
    {
        /// <summary>
    ...
    internal enum CreateDispositionRequest : UInt32
    {
        /// <summary>
        /// </summary>
    ...
    internal enum CreateOptionsRequest : UInt32
    {
        /// <summary>
        /// </summary>
